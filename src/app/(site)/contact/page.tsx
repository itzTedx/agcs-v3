	...
	return (
        ...
        `}
			...
			<div className="flex flex-col">
				<header className="relative border-muted-foreground/15 border-b bg-primary">
					<FlickeringGrid
						className="mask-[radial-gradient(14rem_circle_at_center,transparent,white)] md:mask-[radial-gradient(720px_circle_at_center,transparent,white)] absolute inset-0 z-0 size-full opacity-25"
						color="#0284c7"
						flickerChance={0.1}
						gridGap={6}
						maxOpacity={0.5}
					...
					<div className="container flex h-56 max-w-7xl flex-col justify-between py-6 md:h-72">
						<div className="pt-4 md:pt-9">
							<h1 className="font-semibold text-4xl md:text-6xl">Contact us</h1>
				...
				>
					<div className="max-w-sm max-sm:order-2">
						<TextAnimate
							...
							as={"h2"}
							by="character"
							className="relative z-20 font-medium text-3xl"
							once
						>
						...
						<TextAnimate
							...
							as={"p"}
							by="character"
							className="relative z-20 pt-3 font-light text-lg"
							once
						>
