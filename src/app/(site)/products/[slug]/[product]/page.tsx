		...
		<>
			...
			<article className="container relative">
				...
				<div className="grid gap-6 pb-12 md:grid-cols-5">
					...
					>
						<div className="md:col-span-3">
							<ImagePreview alt={product.title} data={product.image} />
						</div>
					</Suspense>
					...
					<div className="md:col-span-2 md:p-6">
						...
						<h1 className="font-bold text-4xl md:pt-4">{product.title}</h1>
						<meta content={product.title ?? "Product"} itemProp="name" />
						<p className="py-3 font-light text-lg" itemProp="description">
							{product.description}
						</p>
			...
			<Suspense fallback={<Skeleton className="h-64 w-full" />}>
				<RecentlyViewedProducts category={slug} productId={product._id} />
			</Suspense>
		</>
	);
}
