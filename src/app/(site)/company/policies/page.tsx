...
export default function PoliciesPage() {
	return (
		<>
			...
			<main className="bg-base-100 text-black dark:bg-neutral dark:text-white">
				<h1 className="container mx-auto max-w-7xl p-8 pt-4 pb-12 font-bold text-3xl text-sky-600 md:pt-12 md:text-6xl">
					Privacy Policy
				</h1>
				...
				<div className="container mx-auto grid max-w-7xl grid-flow-row grid-cols-1 gap-12 p-8 py-12 md:grid-cols-2">
					<h3 className="font-bold text-3xl">Consent</h3>
					<ul className="space-y-6 text-justify">
						<li>
					...
					<h3 className="font-bold text-3xl">Information we collect</h3>
					<ul className="space-y-6 text-justify">
						<li>
					...
					<h3 className="font-bold text-3xl">How we use your information</h3>
					<ul className="space-y-6 text-justify">
						<li>
					...
					<h3 className="font-bold text-3xl">Log Files</h3>
					<ul className="space-y-6 text-justify">
						<li>
					...
					<h3 className="font-bold text-3xl">Third Party Privacy Policies</h3>
					<ul className="space-y-6 text-justify">
						<li>
					...
					<h3 className="font-bold text-3xl">GDPR Data Protection Rights</h3>
					<ul className="space-y-6 text-justify">
						<li>
					...
					<h3 className="font-bold text-3xl">Children{`'`}s Information</h3>
					<ul className="space-y-6 text-justify">
						<li>
				...
				<p className="pb-6 text-center font-light text-gray-400 text-xs">
