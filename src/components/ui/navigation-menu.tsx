...
const navigationMenuTriggerStyle = cva(
	"group inline-flex h-9 w-max cursor-pointer items-center justify-center rounded-md py-3 font-base text-lg outline-ring/50 ring-ring/10 transition-[color,box-shadow] hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus-visible:outline-1 focus-visible:ring-4 disabled:pointer-events-none disabled:opacity-50 data-[state=open]:bg-accent/50 data-[state=open]:text-accent-foreground data-[state=open]:focus:bg-accent data-[state=open]:hover:bg-accent md:font-medium md:text-sm lg:px-4 dark:outline-ring/40 dark:ring-ring/20"
);
	...
	return (
		...
		>
			<NavigationMenuPrimitive.Viewport
				className={cn(
					"data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full origin-top-center overflow-hidden rounded-md border bg-navbar text-popover-foreground shadow backdrop-blur-lg data-[state=closed]:animate-out data-[state=open]:animate-in md:w-[var(--radix-navigation-menu-viewport-width)]",
					className
				)}
