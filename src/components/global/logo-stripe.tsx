...
export const LogoStrip = memo(function LogoStrip() {
	...
	const industrialPartners = [
		{ src: "/images/logos/pinger.png", alt: "Pinger" },
		{ src: "/images/logos/responsive.jpg", alt: "Responsive" },
		{ src: "/images/logos/ducast.png", alt: "Ducast" },
		{ src: "/images/logos/greenovoc.jpg", alt: "Greenovoc" },
		{ src: "/images/logos/kimmco.png", alt: "Kimmco" },
		{ src: "/images/logos/fipco.png", alt: "Fipco" },
	];

	const materialPartners = [
		{ src: "/images/logos/acfa.jpg", alt: "ACFA" },
		{ src: "/images/logos/solatube.gif", alt: "Solatube" },
		{ src: "/images/logos/skylux.jpg", alt: "Skylux" },
		{ src: "/images/logos/twe.jpg", alt: "TWE" },
		{ src: "/images/logos/alstone.jpg", alt: "Alstone" },
		{
			src: "/images/logos/sna.webp",
			alt: "SNA Sound and Acoustic",
		},
