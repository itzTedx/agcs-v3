export function SidebarSkeleton() {
	return (
		<aside className="sticky top-16 z-10 hidden h-fit animate-pulse rounded-lg px-4 py-2 backdrop-blur-lg max-sm:bg-white/80 md:top-12 md:py-12 lg:block">
			<div className="h-4 w-1/3 rounded bg-gray-200 text-start" />
			<div className="h-6 w-1/4 rounded bg-gray-200 text-2xl md:mb-3" />
			<ul className="space-y-3 pb-3">
				<li>
					<div className="h-10 w-full justify-start rounded border-sky-300 bg-primary/10 shadow-none" />
				</li>
				<li>
					<div className="h-10 w-full justify-start rounded border-sky-300 bg-primary/10 shadow-none" />
				</li>
